...
o3 = input("->")
while o3 not in ["1", "2", "3", "4", "5", "6", "7", "8", "9"] or o3 in [
    o1,
    x1,
    x2,
    o2,
...
x4 = input("->")
while x4 not in ["1", "2", "3", "4", "5", "6", "7", "8", "9"] or x4 in [
    o1,
    x1,
    o2,
    x2,
...
o4 = input("->")
while o4 not in ["1", "2", "3", "4", "5", "6", "7", "8", "9"] or o4 in [
    o1,
    x1,
    x2,
    o2,
...
x5 = input("->")
while x5 not in ["1", "2", "3", "4", "5", "6", "7", "8", "9"] or x5 in [
    o1,
    x1,
    o2,
    x2,
